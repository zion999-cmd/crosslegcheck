...
/* Private variables ---------------------------------------------------------*/
/* USER CODE BEGIN PV */
/* Manual DMA handle for USART2 TX (initialized in MSP)
 * Wrap in a macro so builds don't break if platform DMA mappings differ.
 * Define ENABLE_USART2_MANUAL_DMA to enable this manual init.
 */
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  HAL_NVIC_DisableIRQ(USART2_IRQn);
    ...
    /* Deinit and disable DMA resources for USART2 TX if used */
  #ifdef ENABLE_USART2_MANUAL_DMA
